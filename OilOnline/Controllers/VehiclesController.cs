...
namespace OilOnline.Controllers
{
    ...
    {
        private readonly OilOnlineContext _context;

        public VehiclesController(OilOnlineContext context)
        {
            _context = context;
        }
        ...
        {
            var oilOnlineContext = _context.Vehicles.Include(v => v.Oil);
            return View(await oilOnlineContext.ToListAsync());
        }
        ...
        {
            ViewData["OilTypeId"] = new SelectList(_context.OilTypes, "Id", "Id");
            return View();
        }
